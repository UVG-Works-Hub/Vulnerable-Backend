...
const getTopEnfermedades = "SELECT enfermedades.nombre_enfermedad, COUNT(*) as cantidad FROM enfermedades_pacientes JOIN enfermedades ON enfermedades_pacientes.enfermedad_id = enfermedades.enfermedad_id GROUP BY enfermedades.nombre_enfermedad ORDER BY cantidad DESC LIMIT 10;";
